...
public class Interfaccia {
	...
	private void initialize() {
		...
		btnLoad.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				if (chckbxmntmBand.isSelected() == true) {
					textPane.setText("Resistor value: " + r.getOhm(band1, band2, band4) + "Ω\n" + "Tolerance: " + r.getTol(tolerance));
				} else if (chckbxmntmBand_1.isSelected()== true) {
					textPane.setText("Resistor value: " + r.getOhm(band1, band2, band3,band4) + "Ω\n" + "Tolerance: " + r.getTol(tolerance));
				} else if (chckbxmntmBand_2.isSelected() == true) {
					textPane.setText("Resistor value: " + r.getOhm(band1, band2, band4) + "Ω\n");
				}else if (chckbxmntmBand_3.isSelected() == true) {
					textPane.setText("Resistor value: " + r.getOhm(band1, band2, band3,band4) + "Ω\n" + "Tolerance: " + r.getTol(tolerance) + "\nPPM: " + r.getPPM(ppm));
